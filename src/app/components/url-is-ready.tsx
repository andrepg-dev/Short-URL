...
export default function URLIsReady() {
  ...
  return link !== "" && <div className="mt-5 border w-full bg-primary text-white py-5 animate-fade-in">
    ...
    <div className="text-center text-sm md:text-base">
      <span className="text-center !text-orange-500 underline hover:bg-orange-900 hover:!text-white p-1 px-3 rounded transition cursor-pointer select-none md:select-text" onClick={handleOnClick}>{link}</span>
    </div>
  </div>
}